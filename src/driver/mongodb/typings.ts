...
export interface MongoClientOptions {
     ...
     */
    sslCA?: any; // TODO(Sunjc) implement `Buffer`
...
export declare class Binary {
     ...
     */
    constructor(buffer: any /* Buffer */, subType?: number); // TODO(Sunjc) avoid using any
     ...
     */
    read(position: number, length: number): any; // TODO(Sunjc) avoid using any
     ...
     */
    write(buffer: string, offset: number): void; // TODO(Sunjc) avoid using any
}
/**
